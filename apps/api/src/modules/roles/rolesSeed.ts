...
const ROLE_DESCRIPTIONS: Record<RoleCode, string> = {
  ...
  [RoleCode.HR]: "Same project/task authority as Project Manager, plus org-wide visibility into employee workload and time logs.",
  [RoleCode.ACCOUNTS]: "Same project/task authority as HR/Project Manager, plus org-wide visibility for payroll, billing, and financial reporting.",
