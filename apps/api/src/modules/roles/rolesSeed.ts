...
const ROLE_NAMES: Record<RoleCode, string> = {
  ...
  [RoleCode.ESTIMATION]: "Admin and Finance",
...
const ROLE_DESCRIPTIONS: Record<RoleCode, string> = {
  ...
  [RoleCode.ESTIMATION]: "Same operational Workflow authority and org-wide visibility as Accounts, for admin/finance reporting.",
