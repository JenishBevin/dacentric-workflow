...
export function useUpdateEmployee() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({ employeeId, ...payload }: { employeeId: string; fullName?: string; employeeCode?: string; workEmail?: string; jobTitle?: string | null; departmentId?: string | null; teamIds?: string[]; isActive?: boolean }) =>
